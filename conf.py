...
BLOG_AUTHOR = "Gabriel Pickard"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/pages/about/", "About"),
        ("https://twitter.com/werg", "Twitter"),
...
#                                   # see https://dev.twitter.com/cards/types
    'site': '@werg',         # twitter nick for the website
    'creator': '@werg',     # Username for the content creator / author.
}
